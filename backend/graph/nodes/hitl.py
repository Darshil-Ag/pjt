"""
Node: HITL (Human-in-the-Loop)
Responsibility: Generate clarifying question; pause graph with persisted checkpoint;
                resume with user's answer merged into digital_twin (SRS F-09)
